...
import { SignalAnalyzerTool } from '../tools/SignalAnalyzer/SignalAnalyzerTool';
  ...
  return (
    <SectionShell id={id} variant="dark">
      ...
      <p className="microcopy muted">
        Schreibe oder paste ein Signal – wir parsen es live, prüfen die Claims gegen den Chart und zeigen dir, was
        davon tragfähig ist.
      </p>
      <Card variant="outlined" padding="lg">
        ...
        <div className="signal-analyzer-live">
          <div className="live-signal-tool">
            <SignalAnalyzerTool />
          </div>
          <div className="analysis-sidecar">
